...
<div id="newFilaModal" class="newFilaModal d-flex mx-auto z2 bg-shadow off"> <!-- //Aquí se activa el modal, ponendo "on" -->
    ...
    <div class="d-flex row col-9  m-auto h-50 align-content-center col-12 col-xl-8 col-sm-11">        
        ...
        <div id="modalNewFila" class="d-flex row justify-content-center col-12 azul1 border-azul m-auto h-auto text-center text-light p-2 rounded">             
                        
            <span class="m-3 row t-azul1" ><h4>Registra el nuevo activo:</h4></span>            
            <div class="d-flex row justify-content-center w-100">
