                                    ...
                                    <div>
                                        <tr class="activos">
                                            <th id="ticker" class="celda opacityOff letter-space-1" scope="row">ETH</th>
                                            ...
                                            <th class="celda"><input id="coti" class="opacityOff text-bold coti text-white text-center border-0 cursor-pointer rounded azulLogo2 h-75 p-1 col-6" type="number" value="1500"></th> <!-- Precio actual de ADA en el mercado -->
