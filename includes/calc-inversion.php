                        <h4 class="mt-5 mb-2 text-light">Cálculo de inversión:</h4>
                        ...
                        <div ng-app="" class="calcRow d-flex col p-3 azul2 rounded space-between justify-content-center align-items-center op80">
                            ...
                            <div class="calcCost text-light col-3">
                                ...
                                <input class="w-75 rounded mb-3 mt-2 text-center text-green azulLogo2 text-bold cursor-pointer" type="number" value='{{n1*n2}}'>
                            </div>
                        </div>